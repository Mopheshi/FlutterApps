...
class RecipeService {
  // 'getData()' returns a Future (with an upper case “F”) because an API’s returned
  // data type is determined in the future (lower case “f”). async signifies this method
  // is an asynchronous operation.
  Future getData(String url) async {
    // 'response' doesn’t have a value until await completes. Response and get() are
  ...
  Future<dynamic> getRecipes(String query, int from, int to) async {
    // Use final to create a non-changing variable. You use await to tell the app to
