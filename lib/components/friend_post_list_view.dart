...
class FriendPostListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      // Create a Column to position the Text followed by the posts in a vertical layout.
      child: Column(
        ...
        children: [
          ...
          ListView.separated(
            ...
            primary: false,
            // Set the scrolling physics to NeverScrollableScrollPhysics. Even though you
            ...
            separatorBuilder: (context, index) {
              // For every item, also create a SizedBox to space each item by 16 points.
