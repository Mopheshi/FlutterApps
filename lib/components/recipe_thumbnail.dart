...
class RecipeThumbnail extends StatelessWidget {
  // This class requires a SimpleRecipe as a parameter. That helps configure your widget.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // The first element of the column is Expanded, which widget holds on to an Image.
          // We want the image to fill the remaining space.
          Expanded(
            // The Image is within the ClipRRect, which clips the image to make the borders rounded.
            child: ClipRRect(
          ...
          // Add the remaining Texts: one to display the recipe’s title and another to display the duration.
          Text(
            recipe.title,
            maxLines: 1,
