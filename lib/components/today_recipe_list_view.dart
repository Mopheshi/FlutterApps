    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Add a Container, 400 points tall, and set the background color to grey. This
          // container will hold your horizontal list view.
          Container(
            height: 400,
            // Make the color transparent.
            color: Colors.transparent,
            // Create ListView.separated. Remember, this widget creates two IndexedWidgetBuilders.
            child: ListView.separated(
              // Set the scroll direction to the horizontal axis.
              scrollDirection: Axis.horizontal,
              // Create the itemBuilder callback, which will go through every item in the list.
              itemBuilder: (context, index) {
                // Get the recipe for the current index and build the card.
                final recipe = recipes[index];
                return buildCard(recipe);
              },
              // Create the separatorBuilder callback, which will go through every item in the list.
              separatorBuilder: (context, index) {
                // For every item, you create a SizedBox to space every item 16 points apart.
