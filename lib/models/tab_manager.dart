...
class TabManager extends ChangeNotifier {
  ...
  // goToRecipes() is a specific function that sets selectedTab to the Recipes tab, which is at index 1.
  void goToRecipes() {
    selectedTab = 1;
    // Notifies all widgets listening to TabManager that Recipes (index = 1) is the selected tab.
    notifyListeners();
  }
}
