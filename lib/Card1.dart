...
class Card1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      // The Center widget has a Container child widget which has three properties, the
      ...
      child: Container(
        ...
        // The third property is child and it has a Column widget, which displays its
        // children vertically.
        child: Column(
          children: [
            // Add author information
            const AuthorCard(
              authorsName: 'Boss Mophe',
              title: 'Smoothie Connoisseur',
              imageProvider: AssetImage('assets/atachiz.jpg'),
            ),
            // Add Positioned text
            ...
            Expanded(
              ...
              child: Stack(
                children: [
                  ...
                  // Finally, position the second text 70 pixels from the bottom and 16 pixels from the
